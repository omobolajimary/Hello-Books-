...
// API to Post book
  create(req, res) {
    ...
    if (req.body.bookName === ' ') {
      ...
      return res.status(200).json({
        message: 'book added successfully', bookName: req.body.bookName, bookId: req.body.bookId, author: req.body.author, bookStatus: req.body.bookStatus, upvote: req.body.upvote,
      });
    }
  ...
  update(req, res) {
    ...
    if (!bookDetails) {
      ...
      res.status(201).json({
        message: 'successful', bookName: req.body.bookName, bookId: req.body.bookId, author: req.body.author, bookStatus: req.body.bookStatus, upvote: req.body.upvote,
      });
    }
  },
  ...
  approveBorrowedBook(req, res) {
    ...
    {
      res.status(404).json({
        message: 'Book currently unavailable to borrow',
        bookName: bookExist.bookName,
        bookId: bookIden,
  ...
  approveReturnedBook(req, res) {
    ...
    res.status(200).json({
      message: 'This book is successfully returned',
